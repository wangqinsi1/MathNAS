...
def makeconfig(blockchoose):
    file=open(r"/CPUblock/block1.pickle","rb")
    b1=pickle.load(file)
    file=open(r"/CPUblock/block2.pickle","rb")
    b2=pickle.load(file)
    file=open(r"/CPUblock/block3.pickle","rb")
    b3=pickle.load(file)
    file=open(r"/CPUblock/block4.pickle","rb")
    b4=pickle.load(file)
    file=open(r"/CPUblock/block5.pickle","rb")
    b5=pickle.load(file)
...
def latencyupdate(netconfig,lat):
    latency= np.loadtxt('latencyCPU.txt', dtype=np.float32, delimiter=' ')  
    latencybase=18.3
